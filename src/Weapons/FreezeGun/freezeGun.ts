import { BasicGun } from "../BaiscGun/basicGun";
import { BasicBullet } from "../BaiscGun/basicBullet";
...
import {
    upgradeAccordingly, UPGRADE_FREEZE_GUN_POWER_AMOUNTS,
    UPGRADE_FREEZE_GUN_POWER_MAX, UPGRADE_FREEZE_GUN_SPEED_AMOUNTS,
    UPGRADE_FREEZE_GUN_SPEED_MIN, UPGRADE_FREEZE_GUN_SPECIAL_AMOUNT
} from "../../Configs/upgradeConfig";
import {
    FREEZEGUN_DEFAULT_RANGE, FREEZEGUN_DEFAULT_COOLDOWN,
    FREEZEGUN_DEFAULT_DURATION, FREEZEGUN_DEFAULT_PERCENT,
    BASICBULLET_DEFAULT_SPEED, FREEZEBULLET_PARTICLE_NUM,
    FREEZEBULLET_PARTICLE_LIFE
} from "../../Configs/config";
